...
class ContextFinder {
     ...
     */
    static JAXBContext newInstance(Class<?>[] classes, Map<String, ?> properties, String className) throws JAXBException {
    ...
    @Deprecated
    static String firstByServiceLoaderDeprecated(Class<JAXBContext> spiClass,
